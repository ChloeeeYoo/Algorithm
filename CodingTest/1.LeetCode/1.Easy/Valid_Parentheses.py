    ...
    def isValid(self, s: str) -> bool:
        ...
        for _, val in enumerate(s):
            if val in '({[':        # Check whether it is opening bracket
                ...
                if not mem:          # It is 'False' when getting the closing bracket first without getting the opening bracket 
                    return False
                    ...
                    return False
        if not mem:                                        # the number of opening and closing bracket match
            return True
